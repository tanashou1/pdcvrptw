...
| lr103 | 13 | 1292.68 | 15 | 1458.61 | 12.84 | worse_vehicles | 13 | 1325.12 | 2.51 | worse_distance | +2 | +10.07 | worse_vehicles |
...
| lr109 | 11 | 1208.96 | 14 | 1458.50 | 20.64 | worse_vehicles | 13 | 1281.73 | 6.02 | worse_vehicles | +1 | +13.79 | worse_vehicles |
| lr110 | 10 | 1159.35 | 12 | 1269.82 | 9.53 | worse_vehicles | 13 | 1288.09 | 11.10 | worse_vehicles | -1 | -1.42 | better_vehicles |
| lr111 | 10 | 1108.90 | 12 | 1197.24 | 7.97 | worse_vehicles | 12 | 1192.44 | 7.53 | worse_vehicles | +0 | +0.40 | worse_distance |
| lr112 | 9 | 1003.77 | 10 | 1148.84 | 14.45 | worse_vehicles | 11 | 1199.10 | 19.46 | worse_vehicles | -1 | -4.19 | better_vehicles |
...
| lrc103 | 11 | 1258.74 | 11 | 1279.94 | 1.68 | worse_distance | 13 | 1627.67 | 29.31 | worse_vehicles | -2 | -21.36 | better_vehicles |
| lrc104 | 10 | 1128.40 | 11 | 1170.62 | 3.74 | worse_vehicles | 11 | 1235.61 | 9.50 | worse_vehicles | +0 | -5.26 | better_distance |
| lrc105 | 13 | 1637.62 | 14 | 1653.71 | 0.98 | worse_vehicles | 14 | 1701.79 | 3.92 | worse_vehicles | +0 | -2.83 | better_distance |
| lrc106 | 11 | 1424.73 | 14 | 1589.64 | 11.57 | worse_vehicles | 14 | 1585.55 | 11.29 | worse_vehicles | +0 | +0.26 | worse_distance |
| lrc107 | 11 | 1230.14 | 12 | 1285.93 | 4.54 | worse_vehicles | 13 | 1447.54 | 17.67 | worse_vehicles | -1 | -11.16 | better_vehicles |
...
| lrc205 | 4 | 1302.20 | 4 | 1302.20 | 0.00 | match | 5 | 1395.05 | 7.13 | worse_vehicles | -1 | -6.66 | better_vehicles |
| lrc206 | 3 | 1159.03 | 4 | 1595.94 | 37.70 | worse_vehicles | 4 | 1368.17 | 18.04 | worse_vehicles | +0 | +16.65 | worse_distance |
...
- Better vehicle count than reference on strict-feasible cases: 0
- Worse vehicle count than reference on strict-feasible cases: 35
- Average distance gap on strict-feasible cases: 7.71%
...
- OR-Tools better distance than Rust on same-vehicle cases: 10
- Rust better distance than OR-Tools on same-vehicle cases: 16
- Average OR-Tools distance gap vs Rust: 3.47%
- Average OR-Tools distance gap vs Rust on same-vehicle cases: 2.61%
